    ...
    public void searchItem(final String query){
        ...
        queryForSearchUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (snapshot1.getKey().equals("name")){
                            ...
                            if (name.toLowerCase().contains(query.toLowerCase())){
                                ...
                                if (userID.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                                    ...
                                    User user = new User(name,email,mobile,userID,photoUrl);//new User(name, email, providerId, photoUrl, artistType, mobile, country, state, city, userID, fcmId);
                ...
                {
                    Toast.makeText(SearchResultActivity.this, "Search result doesn't match!!!", Toast.LENGTH_SHORT).show();
                    finish();
                }
