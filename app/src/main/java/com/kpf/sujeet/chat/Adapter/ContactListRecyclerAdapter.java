...
public class ContactListRecyclerAdapter extends RecyclerView.Adapter<ContactListRecyclerAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            Toast.makeText(context, ""+user.name+user.mobno+user.uid, Toast.LENGTH_SHORT).show();
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if(userList.get(position).photoUrl.equals("")) {
            ...
            holder.network_chat_image.setImageUrl(userList.get(position).photoUrl, imageLoader);
        }
